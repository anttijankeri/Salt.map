/*
  ...
  - Changed the type of `userId` on the `Coordinates` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.

*/
-- DropForeignKey
ALTER TABLE "Coordinates" DROP CONSTRAINT "Coordinates_userId_fkey";

-- AlterTable
ALTER TABLE "Coordinates" DROP COLUMN "userId",
